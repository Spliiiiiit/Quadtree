...
func (g *Game) Update() error {
	...
	g.camera.Update(g.character.Moving, g.character.X, g.character.Y, g.character.XInc, g.character.YInc)
	g.floor.Update(g.camera)
	g.teleporter.Update(&g.character.X, &g.character.Y, &g.camera.X, &g.camera.Y, g.floor.Content)
